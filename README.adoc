...
:image-uri-cf-push: https://raw.githubusercontent.com/nevenc-pivotal/pcf-environment-performance-test/master/cf_push.png
:image-uri-cf-delete: https://raw.githubusercontent.com/nevenc-pivotal/pcf-environment-performance-test/master/cf_delete.png
